...
<script type="text/javascript">
    ...
    export default {
        ...
        methods: {
            ...
            changeTab(index, e) {
                console.log('changeTab' + index + 'e=' + e);
            ...
            selectFirstItem(index, e) {
                console.log('selectFirstItem' + index + 'e=' + e);
            ...
            selectSecondItem(index, e) {
                console.log('selectSecondItem' + index + 'e=' + e);
